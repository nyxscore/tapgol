...
const GalleryCommentSection = ({ galleryId }) => {
  ...
  const loadComments = async () => {
    try {
      const commentsData = await getGalleryComments(galleryId);
  ...
  const handleSubmitComment = async (e) => {
    ...
    try {
      ...
      await createGalleryComment(galleryId, commentData);
      setNewComment("");
  ...
  const handleEditComment = async (commentId) => {
    ...
    try {
      await updateGalleryComment(commentId, { content: editText.trim() });
