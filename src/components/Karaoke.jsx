  ...
  const [videos, setVideos] = useState([
    {
      ...
      likes: 156,
      comments: 23,
      thumbnail: "https://via.placeholder.com/300x200/FF6B6B/FFFFFF?text=노래방+영상",
      videoUrl: null,
      videoFile: null,
      description: "오늘 노래방에서 부른 김연아의 사랑이란입니다! 많은 시청 부탁드려요~",
      timestamp: "2시간 전"
    },
    {
      id: 2,
      ...
      likes: 89,
      comments: 12,
      thumbnail: "https://via.placeholder.com/300x200/4ECDC4/FFFFFF?text=아이유+커버",
      videoUrl: null,
      videoFile: null,
      description: "아이유의 Blueming을 노래방에서 불러봤어요!",
      timestamp: "5시간 전"
    },
    {
      id: 3,
      ...
      likes: 234,
      comments: 45,
      thumbnail: "https://via.placeholder.com/300x200/45B7D1/FFFFFF?text=BTS+커버",
      videoUrl: null,
      videoFile: null,
      description: "BTS Dynamite 노래방 커버입니다!",
      timestamp: "1일 전"
    }
  ]);
          ...
          <div className="lg:col-span-2">
            {selectedVideo ? (
                    ...
                    {selectedVideo.videoUrl ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center">
                        <div className="text-center">
                          ...
                          <p className="text-gray-400">비디오 파일이 없습니다</p>
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="bg-gray-800 rounded-lg p-4">
                    <div className="flex items-center space-x-3 mb-3">
                      <div className="w-10 h-10 bg-gray-600 rounded-full flex items-center justify-center">
                        <span className="text-sm font-medium">{selectedVideo.user[0]}</span>
                      </div>
                      <div>
                        <p className="font-medium">{selectedVideo.user}</p>
                        <p className="text-sm text-gray-400">{selectedVideo.timestamp}</p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-300">정말 잘 부르셨네요! 목소리가 좋으세요~</p>
                      </div>
                    </div>
                    <div className="flex space-x-3">
                      <div className="w-8 h-8 bg-gray-600 rounded-full flex items-center justify-center">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-300">다음에 같이 노래방 가요!</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="text-center py-20">
                ...
                <p className="text-sm text-gray-500 mt-2">사이드바에서 영상을 클릭하거나 새 영상을 업로드해보세요!</p>
              </div>
            )}
          </div>
                ...
                />
                 ...
                 <input
                   ...
                   onChange={(e) => {
                     ...
                     if (file && file.size > 100 * 1024 * 1024) { // 100MB 제한
                 ...
                 {uploadForm.videoFile && (
                   <div className="mt-2 space-y-1">
                     ...
                     <p className="text-xs text-gray-400">
                       크기: {(uploadForm.videoFile.size / (1024 * 1024)).toFixed(2)}MB
                     </p>
                   </div>
                 )}
